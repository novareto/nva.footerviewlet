# -*- coding: utf-8 -*-
from nva.footerviewlet.interfaces import INvaFooterviewletLayer
from nva.footerviewlet.testing import NVA_FOOTERVIEWLET_FUNCTIONAL_TESTING
from nva.footerviewlet.testing import NVA_FOOTERVIEWLET_INTEGRATION_TESTING
...
class ViewletIntegrationTest(unittest.TestCase):
    ...
    def test_footer_viewlet_is_registered(self):
        ...
        manager.update()
        my_viewlet = [v for v in manager.viewlets if v.__name__ == 'footer-viewlet']  # NOQA: E501
        self.assertEqual(len(my_viewlet), 1)

    # XXX would be nice to have this test working:
    # def test_footer_viewlet_is_not_available_on_newsitem(self):
...
class ViewletFunctionalTest(unittest.TestCase):
    ...
    layer = NVA_FOOTERVIEWLET_FUNCTIONAL_TESTING
